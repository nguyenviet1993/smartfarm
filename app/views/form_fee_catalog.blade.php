        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        @if(Session::has('success_fee_catalog'))
                            <div class="alert alert-success">{{Session::get('success_fee_catalog')}}</div>
                        @endif
                        <form action="/add-fee-catalog-action" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Nhập tên chi phí" name="catalog_name" id="catalog_name"
                                           required/>
                                </div>
                            </div>
                            <div class="control-group">
            ...
            <div class="span6">
                <div class="widget-box">
                    ...
                    @if(Session::has('success_delete_fee_catalog'))
                        <div class="alert alert-success">{{Session::get('success_delete_fee_catalog')}}</div>
                    @endif
                    <div class="widget-content nopadding">
