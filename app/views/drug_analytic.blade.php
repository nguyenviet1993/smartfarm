                                ...
                                <div class="widget-content nopadding">
                                    <table class="table table-bordered table-striped" id="table_fee">
                                        ...
                                        @foreach($drugs as $key=>$value)
                                            <tr>
                                                <td><a href="/drug-details?id={{$value['drug_id']}}&lake_id={{$lake_id}}&from_date={{@$from_date}}&to_date={{@$to_date}}">{{$value['drug_name']}}</a></td>
                                                <td><a href="/drug-details?id={{$value['drug_id']}}&lake_id={{$lake_id}}&from_date={{@$from_date}}&to_date={{@$to_date}}">{{$value['amount']}}</a></td>
                                            </tr>
                                        @endforeach
                                        <tr>
