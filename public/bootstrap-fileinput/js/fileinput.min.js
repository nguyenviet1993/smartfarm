...
!function (e) {
    ...
    var i, t, a, r, n, l, o, s, d, c, p, u, f, v, g, m, h, w, b, C, x, y, T, F, I, E, $, k, P, S, D, U, A, j, L, z, O,
        R, M, B, N, Z, H, W, q, _, V, K, X, J, Q, Y, G, ee;
    i = ".fileinput", t = window.URL || window.webkitURL, a = function (e, i, t) {
        ...
        data: {}, init: function (e) {
            ...
            var r, n, l = "init_" + t, s = o.data[i], d = s.config[t], c = s.initId + "-" + l,
            ...
            var r = a.config[i], n = X("caption", r) ? r.caption : "", l = X("width", r) ? r.width : "auto",
                s = X("url", r) ? r.url : !1, d = X("key", r) ? r.key : null, c = s === !1 && t,
        ...
        constructor: ee, validate: function () {
            ...
            var i, t = this, a = t.$container.find(".fileinput-upload"),
                r = !a.hasClass("disabled") && V(a.attr("disabled"));
            ...
            var t, a = this;
            return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message ? (t = e.extend(!0, {}, a.getOutData(), i), t.abortData = a.ajaxAborted.data || {}, t.abortMessage = a.ajaxAborted.message, a.cancel(), a.setProgress(100), a.showUploadError(a.ajaxAborted.message, t, "filecustomerror"), !0) : !1
            ...
            i.addError(a), i.isError = !0, i.updateFileDetails(0), r.fadeIn(800), i.raise("fileerror", [e]), i.clearFileInput(), u(i.$container, "has-error")
        }, setProgress: function (e, i) {
            var t = this, a = Math.min(e, 100), r = 100 > a ? t.progressTemplate : t.progressCompleteTemplate;
            i = i || t.$progress, V(r) || i.html(r.replace(/\{percent}/g, a))
        }, lock: function () {
            var e = this;
            ...
            var r, n, l, s, d, c, p, f, v, g, m = this, h = m.getFileStack().length, w = new FormData,
            ...
            m.formdata = w, m.showPreview && (n = e("#" + b + ":not(.file-preview-initial)"), s = n.find(".kv-file-upload"), d = n.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")), 0 === h || !C || s && s.hasClass("disabled") || m.abort(x) || (g = function (e, i) {
                ...
                r = m.getOutData(t), m.fileBatchCompleted = !1, m.showPreview && (n.hasClass("file-preview-success") || (m.setThumbStatus(n, "Loading"), u(n, "file-uploading")), s.attr("disabled", !0), d.attr("disabled", !0)), a || m.lock(), m.raise("filepreupload", [r, b, i]), e.extend(!0, x, r), m.abort(x) && (t.abort(), m.setProgress(100))
            }, p = function (t, l, o) {
            ...
            var i, t, a, r, n, l = this, o = l.filestack, s = o.length, d = {},
            ...
            i.showPreview && (i.$preview.find(".kv-file-remove").each(function () {
                var t, a, r, n, s = e(this), d = s.closest(".file-preview-frame"), c = d.attr("id"),
                ...
                l(s, "click", function () {
                    return n = i.raise("filepreremove", [c, p]), n !== !1 && i.validateMinCount() ? (t = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function () {
                        ...
                        var n = i.getFileStack(!0), l = n.length, s = o.count(i.id),
            ...
            var i = this, t = i.$errorContainer;
            e && (i.addError(i.msgFoldersNotAllowed.replace(/\{n}/g, e)), t.fadeIn(800), u(i.$container, "has-error"), i.raise("filefoldererror", [e]))
            ...
            return 0 === r.find("ul").length ? a.addError("<ul>" + l + "</ul>") : r.find("ul").append(l), r.fadeIn(800), a.raise(n, [i]), a.$container.removeClass("file-input-new"), u(a.$container, "has-error"), !0
        }, showError: function (e, i, t) {
            var a = this, r = a.$errorContainer, n = t || "fileerror";
            return i = i || {}, i.reader = a.reader, a.addError(e), r.fadeIn(800), a.raise(n, [i]), a.isUploadable || a.clearFileInput(), a.$container.removeClass("file-input-new"), u(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
            ...
            if (this.showPreview) {
                var n = this, l = "", o = i ? i.name : "", s = t.createObjectURL(i),
                    d = a.slice(a.lastIndexOf("-") + 1), c = n.previewSettings.other || q.other,
                    p = n.renderFileFooter(i.name, c.width),
                    u = n.parseFilePreviewIcon(n.getPreviewTemplate("other"), o);
            ...
            if (this.showPreview) {
                var n, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c),
                    ...
                    g = u && u.indexOf(d) >= 0, m = X(d, s.previewSettings) ? s.previewSettings[d] : q[d],
            ...
            var r, n = this, l = n.$element, o = n.$preview, s = n.reader, d = n.$previewContainer,
                c = n.$previewStatus, p = n.msgLoading, u = n.msgProgress, f = n.previewInitId, v = i.length,
                g = n.fileTypeSettings, m = n.filestack.length, h = function (t, a, l, o) {
                    var s = e.extend(!0, {}, n.getOutData({}, {}, i), {id: l, index: o}),
                        d = {id: l, index: o, file: a, files: i};
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(i, function (e, i) {
                ...
                var w, b, C, x, y, T, F = m + e, I = f + "-" + F, E = i[e], $ = n.slug(E.name), k = (E.size || 0) / 1e3,
                    P = "", S = t.createObjectURL(E), D = 0, U = n.allowedFileTypes, A = V(U) ? "" : U.join(", "),
                    j = n.allowedFileExtensions, L = V(j) ? "" : j.join(", ");
                if (V(j) || (P = new RegExp("\\.(" + j.join("|") + ")$", "i")), k = k.toFixed(2), n.maxFileSize > 0 && k > n.maxFileSize)return x = n.msgSizeTooLarge.replace("{name}", $).replace("{size}", k).replace("{maxSize}", n.maxFileSize), void(n.isError = h(x, E, I, e));
                if (!V(U) && K(U)) {
                    for (C = 0; C < U.length; C += 1)y = U[C], b = g[y], T = void 0 !== b && b(E.type, $), D += V(T) ? 0 : T.length;
                    if (0 === D)return x = n.msgInvalidFileType.replace("{name}", $).replace("{types}", A), void(n.isError = h(x, E, I, e))
                }
                return 0 !== D || V(j) || !K(j) || V(P) || (T = a($, P), D += V(T) ? 0 : T.length, 0 !== D) ? n.showPreview ? (o.length > 0 && void 0 !== FileReader ? (c.html(p.replace("{index}", e + 1).replace("{files}", v)), d.addClass("file-thumb-loading"), s.onerror = function (e) {
                    ...
                    n.previewFile(e, E, i, I, S), n.initFileActions()
                    ...
                    }, 100), n.raise("fileloaded", [E, I, e, s])
                ...
                }, w = X("text", g) ? g.text : _.text, w(E.type, $) ? s.readAsText(E, n.textEncoding) : s.readAsArrayBuffer(E)) : (n.previewDefault(E, I), setTimeout(function () {
                    r(e + 1), n.updateFileDetails(v)
                }, 100), n.raise("fileloaded", [E, I, e, s])), void n.addToStack(E)) : (n.addToStack(E), setTimeout(r(e + 1), 100), void n.raise("fileloaded", [E, I, e, s])) : (x = n.msgInvalidFileExtension.replace("{name}", $).replace("{extensions}", L), void(n.isError = h(x, E, I, e)))
            }, r(0), n.updateFileDetails(v, !1)
        }, updateFileDetails: function (e) {
            var i = this, t = i.$element, a = i.getFileStack(),
                r = t[0].files[0] && t[0].files[0].name || a.length && a[0].name || "", n = i.slug(r),
                l = i.isUploadable ? a.length : e, s = o.count(i.id) + l, d = l > 1 ? i.getMsgSelected(s) : n;
            ...
            var r, n, l, s, d, c, p = arguments.length > 1, u = t.isUploadable, f = 0,
                v = p ? i.originalEvent.dataTransfer.files : a.get(0).files, g = t.filestack.length,
                m = V(a.attr("multiple")), h = m && g > 0, w = 0, b = function (i, a, r, n) {
                    var l = e.extend(!0, {}, t.getOutData({}, {}, v), {id: r, index: n}),
                        o = {id: r, index: n, file: a, files: v};
            ...
            if (t) a = e("<div>" + n.msgValidationError + "</div>").text(), r = '<span class="' + n.msgValidationErrorClass + '">' + n.msgValidationErrorIcon + a + "</span>"; else {
                if (V(i) || 0 === n.$caption.length)return;
        ...
        if (d() || r(9)) {
            ...
            switch (t.shift(), this.each(function () {
                var r, n = e(this), l = n.data("fileinput"), o = "object" == typeof i && i,
                    s = o.language || n.data("language") || "en", d = {};
